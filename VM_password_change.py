...
def main():
    ...
    username = "rachitha"
    login1_password = "password@123"  # Replace with the first password
    login2_password = "passcode@123"  # Replace with the second password
    new_password = "newpassword@123"  # Replace with the desired new password
